 ...
 */
type FormValueOf<T extends ICustomer | NewCustomer> = Omit<T, 'date'> & {
  date?: string | null;
};
...
type CustomerFormDefaults = Pick<NewCustomer, 'id' | 'date'>;
...
type CustomerFormGroupContent = {
  ...
  department: FormControl<CustomerFormRawValue['department']>;
  sessionType: FormControl<CustomerFormRawValue['sessionType']>;
  telephone: FormControl<CustomerFormRawValue['telephone']>;
  date: FormControl<CustomerFormRawValue['date']>;
};
...
export class CustomerFormService {
  createCustomerFormGroup(customer: CustomerFormGroupInput = { id: null }): CustomerFormGroup {
    ...
    return new FormGroup<CustomerFormGroupContent>({
      ...
      department: new FormControl(customerRawValue.department),
      sessionType: new FormControl(customerRawValue.sessionType),
      telephone: new FormControl(customerRawValue.telephone),
      date: new FormControl(customerRawValue.date),
    });
  }
  ...
  private convertCustomerRawValueToCustomer(rawCustomer: CustomerFormRawValue | NewCustomerFormRawValue): ICustomer | NewCustomer {
    return {
      ...rawCustomer,
      date: dayjs(rawCustomer.date, DATE_TIME_FORMAT),
    };
  }
  ...
  private convertCustomerToCustomerRawValue(
    ...
    return {
      ...customer,
      date: customer.date ? customer.date.format(DATE_TIME_FORMAT) : undefined,
    };
  }
}
